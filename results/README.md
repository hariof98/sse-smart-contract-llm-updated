...
| 1 | `phase1_single_llm/` | `gpt-4o-mini_chain_of_thought_...`, `o3_chain_of_thought_...` |
| 2 | `phase2_critique/` | `critique_gpt-4o-mini_to_gpt-4o_chain_of_thought_...` |
| 3 | `phase3_multi_agent/<run-name>/` | `multiagent_gpt-4o-mini_run1_...` (+ `variance.json`) |
| 4 | `phase4_hybrid/<run-name>/` | `hybrid_slither_gpt-4o-mini_run1_...` (+ `variance.json`) |
