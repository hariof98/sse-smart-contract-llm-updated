...
RUN_CONFIGS: dict[str, dict] = {
    # 1. gpt-4o-mini, budget-matched to Phase 2's best-run token budget.
    "budget_matched_mini": {
        "model": "gpt-4o-mini",
    ...
    "uncapped_o3": {
        ...
        "specialist_classes": ALL_SPECIALISTS,
        "runs": 3,
        "run_name": "uncapped_o3",
        "notes": "Upper-bound quality run on the strongest model, no token cap.",
    },
    # 3. Ablation: gpt-4o-mini with NO moderator (union of specialists, dedup).
    ...
    # 4. Ablation: gpt-4o-mini with 2 specialists only (drop timestamp — the
