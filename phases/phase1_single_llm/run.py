...
Usage
-----
    python3 run_phase1.py                  # gpt-4o-mini  (default)
    python3 run_phase1.py --model o3
    python3 run_phase1.py --model gpt-5.5
    python3 run_phase1.py --dry-run        # 3 contracts only (quick smoke-test)

Available models: gpt-4o-mini | gpt-4.1-nano | gpt-5.5 | o3
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            "Model to evaluate. Availability depends on the provider set in\n"
            "shared/config/models.py (USE_OPENAI):\n"
            "  GitHub (free): gpt-4o-mini, gpt-4o\n"
            "  OpenAI (paid): gpt-4.1-nano, gpt-5.5, o3\n"
            f"Active provider models: {list(SUPPORTED_MODELS)}\n"
        ),
    )
    parser.add_argument(
