...
Usage
-----
    python3 -m phases.phase2_critique.run                                  # gpt4o-mini -> gpt41-nano (default, high quota)
    ...
    python3 -m phases.phase2_critique.run --critic gpt41-nano --dry-run          # 3 contracts

Models: gpt4o-mini | gpt4o | gpt41 | gpt41-nano | gpt5 | gpt5-mini | deepseek-r1
"""
